...
import fcoin.rest.future.IFutureRestApi;
import fcoin.rest.future.impl.FutureRestApiV1;
...
public class FutureClient {
	...
	public static void main(String[] args) throws HttpException, IOException {
		...
		*/
		...
		System.out.println("----------期货行情信息:"+futureGetV1.future_ticker("btc_usd", "this_week"));
		...
		//期货下单
		String tradeResultV1 = futurePostV1.future_trade("eth_usd","this_week", "10.134", "1", "1", "0");
