...
public abstract class WebSocketBase {
	...
	private static final org.slf4j.Logger log = LoggerFactory.getLogger(WebSocketBase.class);
	...
	public void start() {
		...
		this.connect();
		timerTask = new Timer();
		timerTask.schedule(moniter, 50000, 50000);
	}
...
//				+ "','binary':'true'}";
	...
	public void futureRealtrades(String apiKey, String secretKey) {
		...
		StringBuilder tradeStr = new StringBuilder(
				"{'event':'addChannel','channel':'ok_sub_spot_bch_btc_ticker','parameters':{'api_key':'")
...
//				.append("'},'binary':'true'}");
	...
	public void getUserInfo(String apiKey, String secretKey) {
		...
		preStr.append(apiKey).append("&secret_key=").append(secretKey);
		String signStr = MD5Util.getMD5String(preStr.toString());
		String channel = "ok_sub_spotcny_userinfo";
		if (siteFlag == 1) {
			channel = "ok_sub_spotusd_userinfo";
		}
		StringBuilder tradeStr = new StringBuilder(
